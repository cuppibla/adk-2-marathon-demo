...
Real fetches would hit weather APIs, GIS services, Strava, etc. For the demo
we hardcode three scenarios (HOT/NORMAL/COLD) selected via the
MARATHON_SCENARIO env var, with an optional MARATHON_SLOW_MO multiplier on
the simulated fetch latencies (useful for stage demos to stretch the
parallel-pulse window).
"""
